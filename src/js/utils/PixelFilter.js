...
export class PixelFilter {
  ...
  setupPostProcess() {
    ...
    this.quad = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), smoothingMaterial);
  ...
  resize() {
    ...
    this.renderTarget.setSize(size.width / this.resolution, size.height / this.resolution);

    this.prevRenderTarget.setSize(size.width / this.resolution, size.height / this.resolution);
  }
}
